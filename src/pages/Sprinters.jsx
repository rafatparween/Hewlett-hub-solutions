...
const Sprinters = () => {
  return (
    <>
      ...
      <div>
        <div className="h-[204px] w-full bg-blue-500">
          <h1 className="text-white">33,601</h1>
          <h2 className="text-white">WiFi & Network Services Completed</h2>
        </div>
      </div>
        ...
        <div className="max-w-screen-xl mx-auto w-90 p-8 bg-white shadow-lg  overflow-hidden mt-20">
          ...
          <div className="md:w-1/2 p-4 flex items-center justify-center">
            ...
            <div className="md:w-1/2 p-4 mt-[76px]">
              ...
              <button className="w-[145px] h-[50px] bg-[#0C71C3]">
